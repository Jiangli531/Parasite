...
class Helper:
    def __init__(self, current_time, params, name, output_name):
        ...
        self.margin = 0.0
        self.num_triplets = 50
        self.triplet_loss_scale_weight = 1.0
        
        self.folder_path = f'./saved_models/{output_name}'
        try:
